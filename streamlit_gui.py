...
# Main App
tabs = st.tabs(["Loan Prediction", "Visualizations"])
with tabs[0]:
...
with tabs[1]:
    st.markdown("## 📊 Visualizations and Model Metrics")

    # Display training and validation confusion matrices
    st.markdown("### Confusion Matrices")
    st.image("train_confusion_matrix.png", caption="Training Confusion Matrix")
    st.image("val_confusion_matrix.png", caption="Validation Confusion Matrix")

    # Display feature distributions and other plots
    st.markdown("### Feature Distributions and Relationships")
    st.image("feature_distributions.png", caption="Feature Distributions")
    st.image("correlation_plot.png", caption="Correlation Among Features")
